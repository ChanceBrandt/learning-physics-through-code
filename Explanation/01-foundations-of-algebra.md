...
1. What operations are currently being applied to x? 
    - Multiplication and Addition 
2. What order were those operations applied? 
    - Starts as x → Multiplication → Addition 
    - x → 4x → 4x + 7 
3. What inverse opations should you use to undo them? 
    - Division and Subtraction as they are the opposite of the operations applied to x
...
5. After your first operation, what equivalent equation do you get? 
    ...
    - 4x = 24 
6. After your second operation, what equivalent equation do you get? 
